...
function StudentForm() {
  ...
  const [message, setMessage] = useState('Complete the fields to register a student.')
  ...
  const handleMouseOver = () => {
    setMessage('Mouse is over the submit button area.')
  }

  const handleSubmit = (event) => {
    event.preventDefault()
    setMessage(`Form submitted for ${formData.name || 'Unknown Student'}`)
    console.log('Form submitted:', formData)
    setFormData({ name: '', email: '', course: '' })
  }

  const handleButtonClick = () => {
    setMessage('Submit button clicked. Processing registration...')
  }
    ...
    <section className="page-section form-page fade-in">
      <div className="form-container slide-up">
        <div className="form-intro">
          <h1>Student Form</h1>
          <p>Use events to interact with the form and see messages update live.</p>
